            ...
            {featuredCocktails.map((cocktail, index) => (
              <div key={index} className="group relative overflow-hidden rounded-lg">
                <div className="aspect-w-3 aspect-h-4 relative h-[400px]">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent md:opacity-0 opacity-70 md:group-hover:opacity-100 transition-opacity duration-300" />
                </div>
